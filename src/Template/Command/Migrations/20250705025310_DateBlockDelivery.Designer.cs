...
namespace Template.Command.Migrations
{
    ...
    [Migration("20250705025310_DateBlockDelivery")]
    partial class DateBlockDelivery
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Template.Domain.ClientAggregate.Address", b =>
                {
                    ...
                    b.Property<DateTime?>("DateFromDeliveryIgnore")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("DateToDeliveryIgnore")
                        .HasColumnType("timestamp with time zone");
